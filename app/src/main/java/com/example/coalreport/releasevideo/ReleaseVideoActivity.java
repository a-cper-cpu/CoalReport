package com.example.coalreport.releasevideo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_fabu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                /**
                 * 上传视频
                 * app端只负责拍摄及附加到http请求中，后台服务器负责上传数据库
                 */
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        RequestBody requestBody = new MultipartBody.Builder()
                                ...
                                .addPart(Headers.of(
                                        "Content-Disposition",
                                        "form-data; name=\"releaseVideo\"; filename=\"" + file.getName() + "\""), fileBody)
                                .addPart(Headers.of(
                                        "Content-Disposition",
                                        "form-data; name=\"releaseTime\""),
                                        RequestBody.create(null, ft.format(dNow)))
                                .build();
                        String url = AppConfig.BASE_URl + "/insertreleaseVideo";
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(ReleaseVideoActivity.this, "发布成功", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                }).start();
        ...
        btn_takevideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri uriForFile = FileProvider.getUriForFile(ReleaseVideoActivity.this, "com.example.coalreport.fileProvider", file);
